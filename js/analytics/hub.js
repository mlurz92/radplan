...
// Reihenfolge in der Navigation (Frage-/Domänen-Logik + Dashboard + Berichte + Einstellungen).
const MODULES = [dashboard, coverage, fairness, yeargrid, curves, absence, compliance, forecast, reports, settings];
